"""
All of the tests still need to be properly rewritten. 
I mainly build some to showcase I am aware of how to do all of it    
"""
import datetime
import logging
import unittest
...
def test_generate_customer_data():
    ...
    for record in data:
        ...
        # continue onwards with more of this dict
